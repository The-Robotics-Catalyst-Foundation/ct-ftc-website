...
>>>>>>> parent of 14b64b2 (Merge pull request #5 from The-Robotics-Catalyst-Foundation/liquid-glass-bento)
          ...
          <img src="https://wpafbstem.com/FTC/img/FTC_logo.png" alt="FTC Logo" class="h-12 object-contain">
        </div>
...
>>>>>>> parent of b02fc9f (Merge pull request #4 from The-Robotics-Catalyst-Foundation/liquid-glass-bento)
    ...
    <div class="pt-8 border-t-2 border-dashed border-black/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
      <p class="text-[10px] font-mono font-black text-slate-500 uppercase tracking-widest order-3 md:order-1">
        © 2026 CT FIRST Tech Challenge
      </p>
      
<div class="flex flex-wrap items-center gap-10 order-1 md:order-2 w-full md:w-auto">
    <div class="flex items-center gap-3">
